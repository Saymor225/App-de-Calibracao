...
const List<Map<String, dynamic>> _GOALKEPPER_DEFAULT_ESTADOS = [
...
class _GoalKepperPageState extends State<GoalKepperPage> {
  ...
  Future<void> _loadEstados() async {
    ...
    if (!success) {
      estadosCarregados = _GOALKEPPER_DEFAULT_ESTADOS
  ...
  Map<String, dynamic> _generateJson() {
    ...
    return {"Goalkeeper": goalkepperData};
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Goalkeeper - Calibration"),
        centerTitle: true,
          ...
          Consumer<ServerConfig>(
            builder: (context, config, child) {
              return UdpSendButton(
                ...
                debugLabel: 'Calibração GOALKEEPER',
              );
            },
          ),
          IconButton(
